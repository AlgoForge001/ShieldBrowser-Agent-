...
const manifest = withOperaSidebar(
  withSidePanel({
    ...
    permissions: ['storage', 'scripting', 'tabs', 'activeTab', 'debugger', 'unlimitedStorage', 'webNavigation', 'offscreen'],
    ...
    web_accessible_resources: [
      {
        resources: [
          ...
          'offscreen/face-detector.html',
          'offscreen/face-detector-worker.js',
          'offscreen/face-api.min.js',
          'offscreen/vision-offscreen.html',
          'offscreen/screen-classifier-worker.js',
          'preview.html',
          'models/**/*',
        ],
